...
Note: To actually run the policy template we will be creating in this lesson, you will need to create a Flexera credential in your Flexera One organization as described in the [Initial Setup](https://github.com/flexera-public/policy_engine_training/blob/main/setup).
