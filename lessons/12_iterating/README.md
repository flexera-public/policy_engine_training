...
That's it for Lesson 12. Please move on to [Lesson 13](https://github.com/flexera-public/policy_engine_training/blob/main/lessons/13_optimization/README.md), where we will learn how to properly optimize a policy template.
